<template>
  <div class="position-relative text-dark">
          ...
          <div class="row justify-content-center mb-2">
            <div class="col-12 text-center">
              <p class="text-muted mb-0">
                This service will help you fill out the court forms required to
                apply for a
                <ToolTip term="Representation Grant" />
                from the Supreme Court of British Columbia when the deceased did
                not leave a will.
              </p>
            </div>
          </div>
          <div class="row g-4 align-items-start">
            <div class="col-12 col-lg-6 fs-5">
              <h2 class="h4 fw-bold mb-3">
                Presently, this service can only be used if:
              </h2>
                ...
                <li class="d-block">
                  ...
                  <ul class="disc-list ms-4">
                    ...
                    <li>
                      An
                      <strong>
                        <ToolTip term="intestate successor" /> or someone
                        nominated by an intestate successor
                      </strong>
                    </li>
      ...
      >
        <div class="card-body">
          <div class="row align-items-start">
            ...
            <div class="col-12 col-lg-6 fs-5">
              <p class="fw-semibold mb-1">Step 1: Register or Login</p>
              <p>
                You will need a Basic BCeID account. If you do not currently
                have a Basic BCeID account you can register for one.
              </p>
              <p class="fw-semibold mb-1">Step 2: Pre-qualifying Questions</p>
              <p>
                Once logged in, click Begin New Session to answer questions to
                ensure that this service is appropriate for you to use.
              </p>
            </div>
            <div class="col-12 col-lg-6 fs-5">
              <p class="fw-semibold mb-1">Step 3: Answer Questions</p>
              <p>
                Our secure online questionnaire uses your answers to fill out
                the court forms required. You can save your work so you can
                proceed at your own pace, any time.
              </p>
              <p class="fw-semibold mb-1">Step 4: Print Your Forms</p>
              <p>
    ...
    <!-- Original Probate Application has a modal definition here see bcgov/representation-grant-app for details on implementation -->
  </div>
</template>
...
<script setup lang="ts">
  ...
  layoutStore.setNavHeader('Represent Someone Who Died');
  layoutStore.setNavSubtitle('(also known as Probate)');
